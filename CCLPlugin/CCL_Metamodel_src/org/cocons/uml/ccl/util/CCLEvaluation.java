...
public class CCLEvaluation {
  ...
  public CommonAST buildTreeTargetSet(String target) {
    try {
      ...
      System.out.println(" buildTreeTargetSet("+target+") has failed: " + e.getMessage());
      return null;
    }
  }
  ...
  public CommonAST buildTreeScopeSet(String scope) {
    try {
      ...
      System.out.println(" buildTreeScopeSet("+scope+") has failed: " + e.getMessage());      
      return null;
    }
  }
