 ...
 * XML Schema.
 * $Id: BusinessExportDescriptor.java,v 1.1 2003/07/12 18:21:45 layekers Exp $
 */
...
**/
public class BusinessExportDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public BusinessExportDescriptor() {
        super();
        xmlName = "business-export";
        ...
        handler = (new XMLFieldHandler() {
            ...
            {
                BusinessExport target = (BusinessExport) object;
    ...
    } //-- de.fhg.isst.ComponentML.BusinessExportDescriptor()
    ...
    **/
    ...
    {
        return de.fhg.isst.ComponentML.BusinessExport.class;
