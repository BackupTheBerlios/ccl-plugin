 ...
 * XML Schema.
 * $Id: BusinessExport.java,v 1.1 2003/07/12 18:21:45 layekers Exp $
 */
...
**/
public class BusinessExport implements java.io.Serializable {
    ...
    **/
    ...
    public BusinessExport() {
        super();
        _methodList = new Vector();
    } //-- de.fhg.isst.ComponentML.BusinessExport()
    ...
    **/
     ...
     * @param reader
    **/
    public static de.fhg.isst.ComponentML.BusinessExport unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (de.fhg.isst.ComponentML.BusinessExport) Unmarshaller.unmarshal(de.fhg.isst.ComponentML.BusinessExport.class, reader);
    } //-- de.fhg.isst.ComponentML.BusinessExport unmarshal(java.io.Reader) 
