 ...
 * XML Schema.
 * $Id: LifecycleImport.java,v 1.1 2003/07/12 18:21:46 layekers Exp $
 */
...
**/
public class LifecycleImport implements java.io.Serializable {
    ...
    **/
    ...
    public LifecycleImport() {
        super();
        _methodList = new Vector();
    } //-- de.fhg.isst.ComponentML.LifecycleImport()
    ...
    **/
     ...
     * @param reader
    **/
    public static de.fhg.isst.ComponentML.LifecycleImport unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (de.fhg.isst.ComponentML.LifecycleImport) Unmarshaller.unmarshal(de.fhg.isst.ComponentML.LifecycleImport.class, reader);
    } //-- de.fhg.isst.ComponentML.LifecycleImport unmarshal(java.io.Reader) 
