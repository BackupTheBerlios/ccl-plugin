 ...
 * XML Schema.
 * $Id: LifecycleExport.java,v 1.1 2003/07/12 18:21:46 layekers Exp $
 */
...
**/
public class LifecycleExport implements java.io.Serializable {
    ...
    **/
    ...
    public LifecycleExport() {
        super();
        _methodList = new Vector();
    } //-- de.fhg.isst.ComponentML.LifecycleExport()
    ...
    **/
     ...
     * @param reader
    **/
    public static de.fhg.isst.ComponentML.LifecycleExport unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (de.fhg.isst.ComponentML.LifecycleExport) Unmarshaller.unmarshal(de.fhg.isst.ComponentML.LifecycleExport.class, reader);
    } //-- de.fhg.isst.ComponentML.LifecycleExport unmarshal(java.io.Reader) 
