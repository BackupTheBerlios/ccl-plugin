 ...
 * XML Schema.
 * $Id: BusinessImport.java,v 1.1 2003/07/12 18:21:45 layekers Exp $
 */
...
public class BusinessImport implements java.io.Serializable {
    ...
    **/
    ...
    public BusinessImport() {
        super();
        _methodList = new Vector();
    } //-- de.fhg.isst.ComponentML.BusinessImport()
    ...
    **/
     ...
     * @param reader
    **/
    public static de.fhg.isst.ComponentML.BusinessImport unmarshal(java.io.Reader reader)
        throws org.exolab.castor.xml.MarshalException, org.exolab.castor.xml.ValidationException
    {
        return (de.fhg.isst.ComponentML.BusinessImport) Unmarshaller.unmarshal(de.fhg.isst.ComponentML.BusinessImport.class, reader);
    } //-- de.fhg.isst.ComponentML.BusinessImport unmarshal(java.io.Reader) 
