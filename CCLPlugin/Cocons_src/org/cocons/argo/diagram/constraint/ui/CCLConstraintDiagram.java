...
public class CCLConstraintDiagram extends CCLDiagram {
  ...
  protected static Action _actionContextbasedConstraint =  new org.argouml.ui.CmdCreateNode(MContextbasedConstraintImpl.class,  "ContextbasedConstraint");
  ...
  public CCLConstraintDiagram() {
    ...
    try { 
    			setName("ccl constraint diagram " + _ConstraintDiagramSerial++); 
    		}
