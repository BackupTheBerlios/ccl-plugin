...
public class ActionShowAllContextPropertyValues extends UMLAction {

  protected static ImageIcon _infoContextPropertyTagsIcon = ResourceLoader.lookupIconResource("ShowAllContextPropertyValues");
  private ModelIterator _modelIterator = ModelIterator.SINGLETON;

  public static ActionShowAllContextPropertyValues SINGLETON = new ActionShowAllContextPropertyValues();

  public ActionShowAllContextPropertyValues() {
    super("ShowAllContextPropertyValues");
  }
