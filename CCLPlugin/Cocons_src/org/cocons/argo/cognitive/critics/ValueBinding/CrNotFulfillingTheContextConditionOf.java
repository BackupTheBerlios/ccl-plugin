...
/**
 * This class implements the "FulfillingTheContextConditionOf" Design Critic with "NOT" as condition type
...
public class CrNotFulfillingTheContextConditionOf extends CrCoCon
{
	public CrNotFulfillingTheContextConditionOf()
	{
		super();
		...
		setPriority(1);
		setDescription("The elements of the target set of a << NOT FULFILLING THE CONTEXT CONDITION OF>> CoCon must NOT fulfill the scope set's context condition");
	}
