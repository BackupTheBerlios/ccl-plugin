...
/**
 * This class implements the "The Same As" Design Critic with no condition type
...
public class CrTheSameAs extends CrCoCon
{
	public CrTheSameAs()
	{
		...
		setPriority(1);
		setDescription("The elements of the target set of a << THE SAME AS>> CoCon must exactly be the same as those of the scope");
	}
    ...
    if (!e.getCoConType2().equals("THE SAME AS"))
    	return NO_PROBLEM;    	    
    /**
     * Now let's check whether the condition type is empty string
     */    
