...
public class XMIReader extends HandlerBase
{
  ...
  protected class Link
  {
    ...
    public String parameterXMIID;
    public String parameterXMIUUID;
  }
...
*/
  ...
  public XMIReader(MFactory p_factory) throws SAXException,
                                              ParserConfigurationException
  {
    this(p_factory, false);
  }

  public XMIReader(boolean validating) throws SAXException,
                                              ParserConfigurationException
  {
    this(null, validating);
  }

  public XMIReader(MFactory p_factory, boolean validating) throws SAXException,
                                              ParserConfigurationException

  {
    ...
    saxpf.setValidating(validating);
  ...
  protected List liStack = null;
  protected List liNameStack = null;
  protected StringBuffer lastString = new StringBuffer();
  protected String lastMethod = "";
  protected boolean lastMethodType=false;
  protected Object lastObject = null;
  protected Element lastXMIExtension = null;
  protected int deepNotModelProcessing = 0;
  ...
  public void startElement(String p_name, AttributeList p_attrs)
  {
    try
    {
      ...
      boolean processed = startUnknown(o, p_name, p_attrs);
  ...
  protected boolean startUnknown(Object o, String p_name, AttributeList p_attrs)
  {
    ...
    else if (o instanceof MTagDefinition)
    {
      processed = processTagDefinitionMain(p_name, p_attrs);
    }
  ...
  protected void endUnknown(Object o, String p_name)
  {
    ...
    {
      postprocessTagDefinitionMain(p_name);
    }
    else if (o instanceof MCallState)
    {
  ...
  public Object process(String p_name, AttributeList p_attrs)
  {
    ...
    return processUnknown(ref, p_name, p_attrs);
  }
  ...
  protected Object processUnknown(boolean ref, String p_name, AttributeList p_attrs)
  {
    ...
    if (nodeName.startsWith("Foundation.",0))
    {
      if (nodeName.startsWith("Extension_Mechanisms.",11))
      {
        ...
        if (lastName.equals("TagDefinition"))
        {
          if (ref)
          {
            Object o = getObjectByRef(p_attrs);
            ...
            MTagDefinition o2 = (MTagDefinition)o;
            String nodeXMIUUID = p_attrs.getValue("xmi.uuidref");
          ...
          else
          {
            ...
            if (null == o || this == o)
            {
              o2 = factory.createTagDefinition();
            }
            else
            {
              o2 = (MTagDefinition)o;
  ...
  public boolean postprocessStereotypeAttributes(String p_name, MStereotype o)
  {
    ...
    if (p_name.startsWith("Foundation.Extension_Mechanisms.Stereotype."))
    {
      ...
      if (lastName.equals("baseClass"))
      {
        o.addBaseClass(lastString.toString());
        return true;
      }
      if (lastName.equals("icon"))
      {
  ...
  public boolean processStereotypeRoles(String p_name, AttributeList p_attrs, MStereotype o)
  {
    ...
    if (p_name.startsWith("Foundation.Extension_Mechanisms.Stereotype."))
    {
      ...
      if (lastName.equals("definedTag"))
      {
        lastMethod = "definedTag";
        lastMethodType = false;
        liStack.add(STATE_MULTIPLE);
        liNameStack.add(p_name);
        return true;
  ...
  public boolean postprocessStereotypeRoles(String p_name, MStereotype o)
  {
    ...
    if (p_name.startsWith("Foundation.Extension_Mechanisms.Stereotype."))
    {
      ...
      if (lastName.equals("definedTag"))
      {
        MTagDefinition el = (MTagDefinition)lastObject;
        if (null != el)
        {
          o.addDefinedTag(el);
          return true;
  ...
  public boolean processModelElementRoles(String p_name, AttributeList p_attrs, MModelElement o)
  {
    ...
    if (p_name.startsWith("Foundation.Core.ModelElement."))
    {
      ...
      if (lastName.equals("referenceTag"))
      {
        lastMethod = null;
        lastMethodType = true;
        liStack.add(STATE_MULTIPLE);
  ...
  public boolean processConstraintRoles(String p_name, AttributeList p_attrs, MConstraint o)
  {
    ...
    if (p_name.startsWith("Foundation.Core.Constraint."))
    {
      ...
      if (lastName.equals("constrainedStereotype"))
      {
        lastMethod = null;
        lastMethodType = true;
        liStack.add(STATE_SINGLE);
  ...
  public boolean postprocessTaggedValueAttributes(String p_name, MTaggedValue o)
  {
    ...
    if (p_name.startsWith("Foundation.Extension_Mechanisms.TaggedValue."))
    {
      ...
      if (lastName.equals("dataValue"))
      {
        o.addDataValue(lastString.toString());
        return true;
      }
  ...
  public boolean processTaggedValueRoles(String p_name, AttributeList p_attrs, MTaggedValue o)
  {
    ...
    if (p_name.startsWith("Foundation.Extension_Mechanisms.TaggedValue."))
    {
      ...
      if (lastName.equals("referenceValue"))
      {
        lastMethod = "referenceValue";
        lastMethodType = false;
        liStack.add(STATE_MULTIPLE);
        liNameStack.add(p_name);
        return true;
  ...
  public boolean processTagDefinitionMain(String p_name, AttributeList p_attrs)
  {
    MTagDefinition o = (MTagDefinition)liStack.get(liStack.size()-1);
  ...
  public void postprocessTagDefinitionMain(String p_name)
  {
    MTagDefinition o = (MTagDefinition)liStack.get(liStack.size()-2);
  ...
  public boolean processTagDefinitionAttributes(String p_name, AttributeList p_attrs, MTagDefinition o)
  {
    if (processModelElementAttributes(p_name, p_attrs, o))
    {
      return true;
    }
    if (p_name.startsWith("Foundation.Extension_Mechanisms.TagDefinition."))
    {
      String lastName = p_name.substring(46);

      if (lastName.equals("tagType"))
      {
        lastMethod = "tagType";
        lastMethodType = true;
        liStack.add(o);
  ...
  public boolean postprocessTagDefinitionAttributes(String p_name, MTagDefinition o)
  {
    if (postprocessModelElementAttributes(p_name, o))
    {
      return true;
    ...
    if (p_name.startsWith("Foundation.Extension_Mechanisms.TagDefinition."))
    {
      ...
      if (lastName.equals("tagType"))
      {
        o.setTagType(lastString.toString());
        return true;
      }
      if (lastName.equals("multiplicity"))
      {
  ...
  public boolean processTagDefinitionRoles(String p_name, AttributeList p_attrs, MTagDefinition o)
  {
    if (processModelElementRoles(p_name, p_attrs, o))
    {
      return true;
  ...
  public boolean postprocessTagDefinitionRoles(String p_name, MTagDefinition o)
  {
    if (postprocessElementRoles(p_name, o))
    {
      return true;
