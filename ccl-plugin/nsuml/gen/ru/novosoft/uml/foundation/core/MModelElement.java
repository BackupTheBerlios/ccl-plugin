...
public interface MModelElement extends MElement
{
  ...
  /**
   * @deprecated  get UML 1.3 tagged value or null  if it was not set
   *
   * */
  public String getTaggedValue(String key);
  /**
   * @deprecated get UML 1.3 tagged value with default
   *
   * */
  public String getTaggedValue(String key, String defValues);
  /**
   * @deprecated set UML 1.3 tagged value
   *
   * */
  public void setTaggedValue(String key, String values);
   ...
   *        remove all links.
   */
  void setReferenceTags(Collection __arg);
  /**
   ...
   */
  void addReferenceTag(MTaggedValue __arg);
  /**
   ...
   */
  void removeReferenceTag(MTaggedValue __arg);
  /**
   * internal use only - should never be called directly.
   * @param __arg ReferenceTag to be referenced
   */
  void internalRefByReferenceTag(MTaggedValue __arg);
  /**
   * internal use only - should never be called directly.
   * @param __arg ReferenceTag to be unreferenced
   */
  void internalUnrefByReferenceTag(MTaggedValue __arg);
}
