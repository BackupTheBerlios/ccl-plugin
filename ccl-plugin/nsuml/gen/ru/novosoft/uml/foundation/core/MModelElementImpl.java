...
public abstract class MModelElementImpl extends MElementImpl implements MModelElement
{
  ...
  Collection _referenceTags = Collections.EMPTY_LIST;
  Collection _referenceTags_ucopy = Collections.EMPTY_LIST; // unmodifyable copy
  // Reflective API Methods
  private final static Method _referenceTag_setMethod = getMethod1(MModelElementImpl.class, "setReferenceTags", Collection.class);
  private final static Method _referenceTag_addMethod = getMethod1(MModelElementImpl.class, "addReferenceTag", MTaggedValue.class);
  private final static Method _referenceTag_removeMethod = getMethod1(MModelElementImpl.class, "removeReferenceTag", MTaggedValue.class);

  /**
   * Gets all links of the association referenceValue(ModelElement)
   *  / referenceTag(taggedValue).
   *
   * @return unmodifyable copy of the current ReferenceTags collection
   */
  public Collection getReferenceTags() {
    checkExists();
    if (null == _referenceTags_ucopy)
    {
      _referenceTags_ucopy = ucopy(_referenceTags);
    }
    return _referenceTags_ucopy;
  }
  /**
   * Sets all links of the association referenceValue(ModelElement)
   *  / referenceTag(taggedValue).
   *
   * @param __arg new collection of ReferenceTags or Collections.EMPTY_LIST to
   *        remove all links.
   */
  public void setReferenceTags(Collection __arg)
  {
    operationStarted();
    try
    {
      ...
      if (sendEvent || logForUndo)
      {
        old = getReferenceTags();
      }
      _referenceTags_ucopy = null;
      Collection __added = bagdiff(__arg,_referenceTags);
      Collection __removed = bagdiff(_referenceTags, __arg);
      Iterator iter3 = __removed.iterator();
      while (iter3.hasNext())
      {
        MTaggedValue o = (MTaggedValue)iter3.next();
        o.internalUnrefByReferenceValue(this);
      }
      Iterator iter4 = __added.iterator();
      while (iter4.hasNext())
      {
        MTaggedValue o = (MTaggedValue)iter4.next();
        o.internalRefByReferenceValue(this);
      }
      _referenceTags = new ArrayList(__arg);
      if (logForUndo)
      {
        logBagSet(_referenceTag_setMethod, old, getReferenceTags());
      }
      if (sendEvent)
      {
        fireBagSet("referenceTag", old, getReferenceTags());
      }
    }
    finally
    {
   ...
   *  / referenceTag(taggedValue).
   *
   * @param __arg ReferenceTag to be linked to this instance
   */
  public final void addReferenceTag(MTaggedValue __arg)
  {
    operationStarted();
    try
    {
      ...
      if (null != _referenceTags_ucopy)
      {
        _referenceTags = new ArrayList(_referenceTags);
        _referenceTags_ucopy = null;
      }
      __arg.internalRefByReferenceValue(this);
      _referenceTags.add(__arg);
      logBagAdd(_referenceTag_addMethod, _referenceTag_removeMethod, __arg);
      if (sendEvent)
      {
        fireBagAdd("referenceTag", old, getReferenceTags(), __arg);
      }
    }
    finally
    {
   ...
   *  / referenceTag(taggedValue).
   *
   * @param __arg ReferenceTag to be unlinked from this instance
   * @throws RuntimeException when __arg is not linked to this instance
   */
  public final void removeReferenceTag(MTaggedValue __arg)
  {
    operationStarted();
    try
    {
      ...
      if (!_referenceTags.remove(__arg))
      {
        throw new RuntimeException("removing not added object");
      }
      __arg.internalUnrefByReferenceValue(this);
      logBagRemove(_referenceTag_removeMethod, _referenceTag_addMethod, __arg);
      if (sendEvent)
      {
        fireBagRemove("referenceTag", old, getReferenceTags(), __arg);
      }
    }
    finally
    {
   ...
   * @param __arg ReferenceTag to be referenced
   */
  public final void internalRefByReferenceTag(MTaggedValue __arg)
  {
    final boolean sendEvent = needEvent();
    Collection old = null;
    if (sendEvent)
  ...
  /**
   * internal use only - should never be called directly.
   * @param __arg ReferenceTag to be unreferenced
   */
  public final void internalUnrefByReferenceTag(MTaggedValue __arg)
  {
    final boolean sendEvent = needEvent();
    Collection old = null;
    if (sendEvent)
  ...
  protected void cleanup(Collection scheduledForRemove)
  {
    ...
    // opposite role: referenceTag this role: referenceValue
    if (_referenceTags.size() != 0)
    {
      setReferenceTags(Collections.EMPTY_LIST);
    }
  ...
  public Object reflectiveGetValue(String feature)
  {
    ...
    if ("referenceTag".equals(feature))
    {
  ...
  public void reflectiveSetValue(String feature, Object obj)
  {
    ...
    if ("referenceTag".equals(feature))
    {
      setReferenceTags((Collection)obj);
      return;
    }
  ...
  public void reflectiveAddValue(String feature, Object obj)
  {
    ...
    if ("referenceTag".equals(feature))
    {
      addReferenceTag((MTaggedValue) obj);
      return;
    }
  ...
  public void reflectiveRemoveValue(String feature, Object obj)
  {
    ...
    if ("referenceTag".equals(feature))
    {
      removeReferenceTag((MTaggedValue) obj);
      return;
    }
  ...
  /**
   * find the TagDefinition for UMNL1.3
   */
  private MTagDefinition lookupUML13TagDefinition(String key)
  {
    Iterator i = this.getNamespace().getOwnedElements().iterator();
    while(i.hasNext())
    {
      MModelElement me = (MModelElement) i.next();
      if (me instanceof MTagDefinition)
      {
        MTagDefinition td = (MTagDefinition)me;
        if(key.equals(td.getName()) &&
           "UML::DataTypes::String".equals(td.getTagType()) &&
           MMultiplicity.M1_1.equals(td.getMultiplicity()) )
        {
          return td;
        }
      }
  ...
  private MTaggedValue lookUpTaggedValue(String key, String type, MMultiplicity m)
  {
    Iterator i = getTaggedValues().iterator();
    while(i.hasNext())
    {
      MTaggedValue tv = (MTaggedValue)i.next();
      MTagDefinition td = tv.getType();
      if(key.equals(td.getName()) && type.equals(td.getTagType()) &&
         m.equals(td.getMultiplicity()))
      {
        return tv;
      }
    }
  ...
  /**
   * @deprecated
   * get UML 1.3 tagged value or null  if it was not set */
  ...
  /**
   * @deprecated
   * get UML 1.3 tagged value with default */
  public String getTaggedValue(String key, String defValue)
  {
    MTaggedValue tv = lookUpTaggedValue(key, "UML::DataTypes::String", MMultiplicity.M1_1);
    if(tv == null)
      return defValue;
    if (tv.getDataValues().size() != 1)
      return null;
    return (String)tv.getDataValues().toArray()[0];
  }

  /**
   * @deprecated
   * set UML 1.3 tagged value */
  public void setTaggedValue(String key, String value)
  {
    // does the tagged value already exists?
    MTaggedValue tv = lookUpTaggedValue(key, "UML::DataTypes::String", MMultiplicity.M1_1);
    if(tv == null)
    {
      // does the TagDefinition already exists?
      MTagDefinition td = lookupUML13TagDefinition(key);
      if (td==null)
      {
        ...
        td.setNamespace(this.getNamespace());
      }
      tv = new MTaggedValueImpl();
      tv.setType(td);
      this.addTaggedValue(tv);
    }
    else
    {
      tv.setDataValues(Collections.EMPTY_LIST);
    }
    tv.addDataValue(value);
  }
