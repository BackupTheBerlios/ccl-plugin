...
public class MFactoryImpl extends MFactory
{
  protected static MFactoryImpl singleton = new MFactoryImpl();
  ...
  public final MTagDefinition createTagDefinition()
  {
    return new MTagDefinitionImpl();
  }
