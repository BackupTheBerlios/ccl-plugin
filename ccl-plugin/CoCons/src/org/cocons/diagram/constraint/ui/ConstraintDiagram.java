...
import org.cocons.diagram.constraint.*;

public class ConstraintDiagram extends UMLDiagram {

  ////////////////
  // actions for toolbar


  protected static Action _actionContextCondition =
  new CmdCreateNode(MContextConditionImpl.class, "ContextCondition");

  protected static Action _actionContextbasedConstraint =
  new CmdSetMode(ModeCreatePolyEdge.class,
		 "edgeClass", MContextbasedConstraint.class,
  ...
  protected void initToolBar() {
    ...
    _toolBar.add(_actionContextCondition);
