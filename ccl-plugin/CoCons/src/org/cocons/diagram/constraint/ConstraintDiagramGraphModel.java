package org.cocons.diagram.constraint;
...
implements MutableGraphModel, VetoableChangeListener, MElementListener {
  ...
  public boolean canAddNode(Object node) {
    return (node instanceof MContextCondition);
  }
  ...
  public boolean canAddEdge(Object edge)  {
    ...
    if (edge instanceof MContextbasedConstraint) {
      end0 = ((MContextbasedConstraint)edge).getConstrainedSet();
      end1 = ((MContextbasedConstraint)edge).getScopeSet();
    }
